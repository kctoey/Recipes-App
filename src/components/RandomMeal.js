...
const RandomMeal = () => {
  ...
  return (
    <div className="h-full w-full min-h-screen bg-gradient-to-r from-sky-500 to-indigo-500 pb-4 px-4">
                  ...
                  <div className="md:leading-4 text-center w-84">
                    ...
                    <div className="px-4 py-4 leading-8 ">
                      ...
                      <h3 className="md:text-xl">
                        Category
                        <span className="uppercase rounded-md ml-2 px-2 md:text-xl bg-indigo-400 tracking-wide text-sm text-white font-semibold w-20">
                          {meal.strCategory}
                        </span>
                      </h3>
                    </div>
